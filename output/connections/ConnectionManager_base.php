...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "ecommerce_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["order_details"] = "ecommerce_at_localhost";
		$connectionsIds["orders"] = "ecommerce_at_localhost";
		$connectionsIds["products"] = "ecommerce_at_localhost";
		$connectionsIds["users"] = "ecommerce_at_localhost";
		$connectionsIds["ecommerce store_users"] = "ecommerce_at_localhost";
