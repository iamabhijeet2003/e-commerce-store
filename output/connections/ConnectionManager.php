...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "ecommerce_at_localhost";
		$data["connName"] = "ecommerce at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;ecommerce;;1"; //currently unused

		$this->_connectionsIdByName["ecommerce at localhost"] = "ecommerce_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "ecommerce";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=ecommerce;OPTION=3";
		// encription set
		...
		$connectionsData["ecommerce_at_localhost"] = $data;
