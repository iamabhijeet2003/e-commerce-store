...
class tDAL
{
	var $tblecommerce_at_localhost__ecommerce_store_users;
	var $tblecommerce_at_localhost__order_details;
	var $tblecommerce_at_localhost__orders;
	var $tblecommerce_at_localhost__products;
	var $tblecommerce_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "ecommerce store_users", "varname" => "ecommerce_at_localhost__ecommerce_store_users", "altvarname" => "ecommerce_store_users", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
		$this->lstTables[] = array("name" => "order_details", "varname" => "ecommerce_at_localhost__order_details", "altvarname" => "order_details", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
		$this->lstTables[] = array("name" => "orders", "varname" => "ecommerce_at_localhost__orders", "altvarname" => "orders", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
		$this->lstTables[] = array("name" => "products", "varname" => "ecommerce_at_localhost__products", "altvarname" => "products", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "ecommerce_at_localhost__users", "altvarname" => "users", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
	}
