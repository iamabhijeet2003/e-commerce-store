...
function checkTableName($shortTName )
{
	...
	if ("order_details" == $shortTName )
		return true;
	if ("orders" == $shortTName )
		return true;
	if ("products" == $shortTName )
		return true;
	if ("users" == $shortTName )
		return true;
	if ("ecommerce_store_users" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("order_details");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("orders");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ecommerce store_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ecommerce store_users";
	}
	return $arr;
}
...
//	default permissions
	...
	if( $table=="ecommerce store_users" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
