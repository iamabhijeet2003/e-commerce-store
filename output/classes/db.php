...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "ecommerce_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "ecommerce store_users", "varname" => "ecommerce_at_localhost__ecommerce_store_users", "altvarname" => "ecommerce_store_users", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
			$dalTables[$conn->connId][] = array("name" => "order_details", "varname" => "ecommerce_at_localhost__order_details", "altvarname" => "order_details", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
			$dalTables[$conn->connId][] = array("name" => "orders", "varname" => "ecommerce_at_localhost__orders", "altvarname" => "orders", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
			$dalTables[$conn->connId][] = array("name" => "products", "varname" => "ecommerce_at_localhost__products", "altvarname" => "products", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "ecommerce_at_localhost__users", "altvarname" => "users", "connId" => "ecommerce_at_localhost", "schema" => "", "connName" => "ecommerce at localhost");
		}
	}
