	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("ecommerce store_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "order_details" ] = array( "url" => "order_details", "type" => 0 );
	$projectEntitiesReverse[ "order_details" ] = "order_details";
	$projectEntities[ "orders" ] = array( "url" => "orders", "type" => 0 );
	$projectEntitiesReverse[ "orders" ] = "orders";
	...
	$projectEntities[ "ecommerce store_users" ] = array( "url" => "ecommerce_store_users", "type" => 0 );
	$projectEntitiesReverse[ "ecommerce_store_users" ] = "ecommerce store_users";
}
